...
public class ConsumerApp
{
    public static void main(String[] args) {
        ...
        try (Consumer<Void, Integer> consumer = new KafkaConsumer<>(configureProperties())) {
    ...
    private static Properties configureProperties() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "my-cluster-kafka-bootstrap-sibtpd-kafka-cluster.apps.eu46r.prod.ole.redhat.com:443");
        ...
        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "/home/andy/AD482/truststore.jks");
